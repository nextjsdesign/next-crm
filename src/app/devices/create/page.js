...
export default function CreateDevicePage() {
  ...
  receptionCondition: "",
  receptionNotes: "",
  sheetType: "Nouă",       // ✅ nou: tip fișă
  selectedDeviceId: null,  // ✅ nou: ID device selectat
  status: "Primire",       // ✅ nou: status implicit
});
  const handleChange = (e) =>
    setForm((prev) => ({ ...prev, [e.target.name]: e.target.value }));
  ...
  const selectClient = async (client) => {
    ...
    setClientDevices(data || []);
      ...
      // resetăm status garanție dacă selectezi un alt client
...
const handleSubmit = async (e) => {
  ...
  try {
    // ✅ Dacă e bazată pe un device anterior, completăm automat câmpurile lipsă
...
{step === 2 && (
  <section className="step-enter bg-white dark:bg-gray-900 p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm">
    ...
    {/* 🔧 Detalii suplimentare dispozitiv */}
...
{step === 3 && (
  <section className="bg-white dark:bg-gray-900 p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm step-enter">
    ...
    {/* 🧾 Urme vizibile / Note recepție */}
    <div className="mb-4">
      <label className="block text-sm font-medium text-gray-600 dark:text-gray-300 mb-2">
        Urme vizibile / Stare estetică
      </label>
      <select
      ...
      >
        ...
        <option value="Fără urme vizibile">Fără urme vizibile</option>
        <option value="Zgârieturi ușoare">Zgârieturi ușoare</option>
        <option value="Urme de uzură evidente">Urme de uzură evidente</option>
        <option value="Carcasa spartă / deteriorată">Carcasa spartă / deteriorată</option>
        <option value="Altă observație (specifică mai jos)">Altă observație...</option>
      </select>
      ...
      <textarea
        ...
        onChange={handleChange}
        placeholder="Ex: zgârieturi laterale, urme pe capac, șurub lipsă..."
      ...
      >
        ...
        {step === 4 && (
          <section className="bg-white dark:bg-gray-900 p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm step-enter">
            ...
            <div className="flex justify-between mt-5">
              <button type="button" onClick={() => setStep(3)} className="btn-gray px-5 py-2.5 text-base">
                ◀ Înapoi
              </button>
              <button type="button" onClick={() => setStep(5)} className="btn-blue px-5 py-2.5 text-base">
                Continuă ▶
              </button>
            </div>
          </section>
  ...
  <section className="bg-white dark:bg-gray-900 p-6 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm step-enter">
    ...
    <div className="space-y-4 text-gray-700 dark:text-gray-300">
      ...
      <div className="border-b border-gray-200 dark:border-gray-700 pb-3">
        ...
        <p>
          {form.deviceType} {form.brand} {form.model} — {form.serialNumber}
        </p>
      </div>
      ...
      <div className="border-b border-gray-200 dark:border-gray-700 pb-3">
        ...
        <p>
          Alimentator: {form.charger} • Baterie: {form.battery} • HDD: {form.hdd}
        </p>
      </div>
